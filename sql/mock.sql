...
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401004, 1, 'Mutton', 'Mutton is the meat of a mature adult sheep, typically between two and three years old', 118);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401005, 3, 'Spinach', 'a leafy green flowering plant native to central and western Asia', 28);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401006, 3, 'cabbage', 'It is a leafy green, red (purple), or white (pale green) biennial plant grown', 24);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
...
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401010, 6, 'green bean', 'Green beans are young, unripe fruits of various cultivars of the common bean.', 329);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401011, 6, 'soybean', 'a species of legume native to East Asia, widely grown for its edible bean', 390);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401012, 2, 'Maize', 'corn', 112);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401013, 2, 'rice', 'the seed of the grass species. ', 346);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401014, 2, 'pasta', 'a type of food typically made from an unleavened dough of wheat flour mixed with water or eggs', 351);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401015, 2, 'wheat', 'a grass widely cultivated for its seed, a cereal grain that is a worldwide staple food', 338);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
    value (2023020821401016, 2, 'bread', 'a staple food prepared from a dough of flour (usually wheat) and water, usually by baking.', 313);
INSERT INTO ingredient(ingredient_id, type_id, ingredient_name, description, calories)
