...
value(2302092140111111,'tester00','cPw1898Mrqie8Eem6GqwNw==','Aa Testa','male','testa@example.com','+10000000000','401 Sunset Ave, Windsor, ON N9B 3P4');
INSERT INTO user(user_id,user_name,password,full_name,gender,email_address,phone_number,address)
value(2302092140222222,'tester01','cPw1898Mrqie8Eem6GqwNw==','Bb Testb','female','testb@example.com','+21111111111','401 Sunset Ave, Windsor, ON N9B 3P4');
INSERT INTO user(user_id,user_name,password,full_name,gender,email_address,phone_number)
value(2302092140333333,'tester02','cPw1898Mrqie8Eem6GqwNw==','Cc Testc','universal','testc@example.com','+32222222222');
INSERT INTO user(user_id,user_name,password,full_name,gender,email_address,phone_number)
value(2302092140444444,'tester03','cPw1898Mrqie8Eem6GqwNw==','Dd Testd','unknown','testd@example.com','+8612345678901');

INSERT INTO recipe(recipe_id,user_id,recipe_type,total_weight,total_calories)
...
INSERT INTO ingredient(ingredient_id,food_name,description,calories)
