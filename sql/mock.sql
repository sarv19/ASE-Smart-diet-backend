...
INSERT INTO ingredient(ingredient_id, ingredient_name, description, calories)
    value (2023020821401001, 'test_food_A', 'apple', 100);
INSERT INTO ingredient(ingredient_id, ingredient_name, description, calories)
    value (2023020821401002, 'test_food_B', 'Banana', 70);
INSERT INTO ingredient(ingredient_id, ingredient_name, description, calories)
    value (2023020821401003, 'test_food_C', 'coconut', 66);
INSERT INTO ingredient(ingredient_id, ingredient_name, description, calories)
    value (2023020821401004, 'test_food_D', 'Dog', 99);
