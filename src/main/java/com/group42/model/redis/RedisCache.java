//package com.group42.model.redis;
//
...
//        try {
//            if (timeout > 0) {
//                redisTemplate.opsForValue().set(key, JSON.toJSONString(value), timeout, TimeUnit.MINUTES);
//            } else {
//                set(key, value);
//            }
//
...
//    /**
//     * 获取缓存的对象
//     * 传进来的targetClass是sessionuser 那么就会得到token对应的值  然后转换成sessionuser类型的对象
//     */
